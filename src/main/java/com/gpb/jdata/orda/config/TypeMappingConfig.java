...
public class TypeMappingConfig {
    private static final Map<String, String> _SOURCE_TYPE_TO_OM_TYPE = Map.<String, String>ofEntries(
            ...
            Map.entry("HLLSKETCH", "HLLSKETCH"),
            Map.entry("SUPER", "SUPER"),
            Map.entry("BOX", "GEOMETRY"),
            Map.entry("CIRCLE", "GEOMETRY"),
            Map.entry("LINE", "GEOMETRY"),
            Map.entry("LSEG", "GEOMETRY"),
            Map.entry("PATH", "GEOMETRY"),
            Map.entry("PG_LSN", "PG_LSN"),
            Map.entry("PG_SNAPSHOT", "PG_SNAPSHOT"),
            Map.entry("TSQUERY", "TSQUERY"),
            Map.entry("TXID_SNAPSHOT", "TXID__SNAPSHOT"),
            Map.entry("XML", "XML"),
            Map.entry("TSVECTOR", "TSVECTOR"),
            Map.entry("MACADDR", "MACADDR"),
            Map.entry("MACADDR8", "MACADDR"),
            Map.entry("CIDR", "CIDR"),
            Map.entry("INET", "INET"),
            Map.entry("TSRANGE", "DATETIMERANGE"),
            Map.entry("BINARY_DOUBLE", "DOUBLE"),
            Map.entry("BINARY_FLOAT", "FLOAT"),
            Map.entry("XMLTYPE", "XML"),
            Map.entry("BFILE", "BINARY"),
            Map.entry("CLOB", "CLOB"),
            Map.entry("NCLOB", "CLOB"),
            Map.entry("LONG", "LONG"),
            Map.entry("LOWCARDINALITY", "LOWCARDINALITY"),
            Map.entry("DATETIME64", "DATETIME"),
            Map.entry("SimpleAggregateFunction()", "AGGREGATEFUNCTION"),
            Map.entry("IPV4", "IPV4"),
            Map.entry("IPV6", "IPV6"),
            Map.entry("VOID", "NULL"),
    ...
    public String mapToOrdaType(String sourceType) {
