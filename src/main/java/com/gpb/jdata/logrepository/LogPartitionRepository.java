package com.gpb.jdata.logrepository;

import com.gpb.jdata.log.SvoiCustomLogger;
import com.gpb.jdata.log.SvoiSeverityEnum;
import com.gpb.jdata.properties.CleanDatabaseLogsProperties;
    ...
    public void dropOldPartitions() {
        ...
        for (String partName : partitions) {
            ...
            if (partDate.isBefore(dateToDelete)) {
                ...
                logsJdbcTemplate.execute(sql);
                svoiCustomLogger.send("cleanLogs", "Clean Logs", "Dropped partition " + partName, SvoiSeverityEnum.ONE);
            }
        }
    }
}